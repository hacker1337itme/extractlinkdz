...
func printUsage() {
    ...
    fmt.Println()
    fmt.Println("Usage:")
    fmt.Println("  linkextract [options]")
    fmt.Println()
    ...
    fmt.Println("  linkextract -url https://api.github.com/users/octocat/repos")
    fmt.Println()
    fmt.Println("  # Extract from curl output")
    fmt.Println("  curl -i https://example.com | linkextract -stdin")
    fmt.Println()
    fmt.Println("  # Extract from browser dev tools copy")
    fmt.Println("  linkextract -raw \"$(pbpaste)\"")
    fmt.Println()
    fmt.Println("  # Extract from .har file")
    fmt.Println("  linkextract -har network.har")
    fmt.Println()
    fmt.Println("  # Extract from saved response")
    fmt.Println("  linkextract -file response.txt")
    fmt.Println()
    fmt.Println("  # Filter by relationship")
    fmt.Println("  linkextract -url https://api.github.com/users/octocat/repos -rel next")
}
